...
Version 1:
-Upload image and write description code functional
-Ability to click once to set the marker, and once again to upload information functional
-Marker location is saved, with information, though on a local database


Changes required:
1-each blue marker stores the same information, not the information input during its creation
2-instead of using the image of a map, Google Maps API should be used(the issue is saving marker location, I am unsure how to do that)
